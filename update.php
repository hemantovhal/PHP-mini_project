		...
		<div class="col-xs-4" style="background-color:white ">
			<form method="post" action="php/update.php">
				<table class="table table-hover"  width="100%">
					...
					<tr>
						<td> <input type="text" name="txtlandline" data-toggle="tooltip" title="Landline Number" value="<?php echo htmlentities($data[4])?>" class="form-control" placeholder="Landline Number" maxlength="12" /> </td>
						<td> <input type="text" name="txtemail" data-toggle="tooltip" title="Email Address" value="<?php echo htmlentities($data[5])?>" class="form-control" placeholder="Email Address" /> </td></td>
						<td></td>
					</tr>
