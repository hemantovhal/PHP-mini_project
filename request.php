            ...
            <!-- Logo -->
                ...
                <div>
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"> <a href="request.php"> Delete From Public </a> </li>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-xs-4" style="background-color:white">
                    <h1 align="center"> Delete Contact From Public Directory </h1> <br/><br/>
                    <form method="post" action="php/delete.php">
                        <div class="input-group">
                            <input type="text" class="form-control" required name="txtdelete" placeholder="Enter Mail-Id" maxlength="10">
        	  			    <span class="input-group-btn">
                                <button class="btn btn-danger" type="submit">To Send Admin</button>
            			    </span>
                            <!-- Indicate Success -->
                        </div><!-- /input-group -->
                    </form>
